...
- - -
>3.1 ) Tail Recursion
- Replica el ejemplo de 3.0a con TailRecursion
- Replica el ejemplo de 3.0b con TailRecursion
- - -
>4.0) Structures
...
- Crea un programa que implemente una matriz (array) bidimensional y que permita sumar, restar y multiplicar matrices. El programa debe también imprimir el resultado en la consola.
- Extiende el programa anterior para que permita ordenar una matriz utilizando diferentes algoritmos de ordenamiento como bubble sort, quicksort o mergesort.
- - -
>4.2) Data Structure: LinkedList
- Crea un programa que implemente una lista enlazada simple y que permita insertar, eliminar y buscar elementos en ella. También puedes agregar la capacidad de imprimir la lista en la consola.
- Extiende el programa anterior para que implemente una lista enlazada doble y una lista circular y que permita insertar, eliminar y buscar elementos en ellas.
- - -
>4.3) Data Structure: Stack/Queue
- Crea un programa que implemente una pila (stack) y una cola (queue) utilizando un array y que permita insertar, eliminar y buscar elementos en ellas. También puedes agregar la capacidad de imprimir la pila y la cola en la consola.
- Extiende el programa anterior para que implemente una pila y una cola utilizando una lista enlazada y que permita insertar, eliminar y buscar elementos en ellas.
- - -
>4.4) Data Structure: Graph
- Crea un programa que implemente un grafo no dirigido y que permita agregar, eliminar y buscar nodos y aristas en él. También puedes agregar la capacidad de imprimir el grafo en la consola.
- Extiende el programa anterior para que implemente un grafo dirigido ponderado y que permita encontrar la ruta más corta entre dos nodos utilizando el algoritmo de Dijkstra.
- - -
>4.5) Data Structure: Tree
- Crea un programa que implemente un árbol binario de búsqueda y que permita insertar, eliminar y buscar nodos en él. También puedes agregar la capacidad de imprimir el árbol en la consola.
- Extiende el programa anterior para que implemente un árbol AVL y un árbol rojo-negro y que permita insertar, eliminar y buscar nodos en ellos.
- - -
>4.6) Data Structure: Trie
- Crea un programa que implemente un trie (árbol de prefijos) y que permita insertar, eliminar y buscar cadenas de caracteres en él. También puedes agregar la capacidad de imprimir el trie en la consola.
- Extiende el programa anterior para que implemente un trie comprimido (compressed trie) y que permita insertar, eliminar y buscar cadenas de caracteres en él.
- - -
>4.7) Data Structure: Heap
- Crea un programa que implemente un heap binario y que permita insertar, eliminar y buscar elementos en él. También puedes agregar la capacidad de imprimir el heap en la consola.
- Extiende el programa anterior para que implemente un heap Fibonacci y que permita insertar, eliminar y buscar elementos en él.
- - -
>4.8) Data Structure: Hashing
- Crea un programa que implemente una tabla de hash (hash table) utilizando una función de hash simple y que permita agregar, eliminar y buscar elementos en ella. También puedes agregar la capacidad de imprimir la tabla de hash en la consola.
- Extiende el programa anterior para que implemente una tabla de hash con resolución de colisiones mediante encadenamiento (chaining) y que permita agregar, eliminar y buscar elementos en ella. También puedes agregar la capacidad de imprimir la tabla de hash en la consola.
- - -
>5 ) OOP Core Concepts
+ Introduction
+ Classes
